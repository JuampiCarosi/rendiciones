...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-primary-bg text-slate-50 shadow hover:bg-primary-bg/90 dark:bg-blue-400 dark:text-blue-800 dark:hover:bg-blue-300/90",
        destructive:
          "bg-red-500 text-slate-50 shadow-sm hover:bg-red-500/90 dark:bg-red-400 dark:text-red-800 dark:hover:bg-red-300",
        success:
          "bg-green-500 text-slate-50 shadow-sm hover:bg-green-500/90 dark:bg-green-400 dark:text-green-800 dark:hover:bg-green-300",
        outline:
